...
function Home() {
  ...
  return (
    <div className="px-4 md:px-6 py-4 min-h-full bg-gradient-to-b from-[#1a1a1a] to-[#121212] overflow-x-hidden">
      <div className="mb-6 md:mb-8 bg-gradient-to-b from-[#3333AA] to-transparent p-4 md:p-8 -mx-4 md:-mx-6 -mt-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6">
            {playlists.map((playlist) => (
              <div 
                ...
                className="bg-[#181818] p-3 md:p-4 rounded-lg hover:bg-[#282828] transition-all duration-300 group relative cursor-pointer"
              >
